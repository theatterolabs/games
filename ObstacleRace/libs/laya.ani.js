                ...
                value: function READ_ANIMATIONS() {
                    ...
                    for (h._templet._anis.length = d, t = 0; t < d; t++) {
                        ...
                        for (c.totalKeyframeDatasLength = 0, e = 0; e < x; e++) {
                            ...
                            var g = o.getUint16();
                            g >= 0 && (y.name = h._strings[g], c.bone3DMap[y.name] = e), y.keyFrame = [], y.parentIndex = o.getInt16(), -1 == y.parentIndex ? y.parent = null : y.parent = c.nodes[y.parentIndex], c.totalKeyframeDatasLength += _,
            ...
            _createClass(c, [{
                ...
                value: function update() {
                    ...
                    if (this.rotation = this.transform.skX, t) i = this.resultTransform.getMatrix(),
                        e.Matrix.mul(i, t, this.resultMatrix), this.resultRotation = this.rotation;
                        ...
                        switch (this._diyTexture && (n = this._diyTexture), this.currDisplayData.type) {
                            ...
                            case 1:
                                ...
                                if (null == this.currDisplayData.bones) {
                                    ...
                                    if (this._parentMatrix)
                                        if (x) e.Matrix.mul(x, this._parentMatrix, e.Matrix.TEMP),
            ...
            _createClass(F, [{
                ...
                value: function init(t) {
                    ...
                    if (this._yReverseMatrix = t.yReverseMatrix, this._aniMode = i, this._templet = t,
                        ...
                        this._rootBone = t.mRootBone, this._aniSectionDic = t.aniSectionDic, t.ikArr.length > 0)
                        for (this._ikArr = [],
                            h = 0, a = t.ikArr.length; h < a; h++) {
                            this._ikArr.push(new A(t.ikArr[h], this._boneList));
                        }
                    if (t.pathArr.length > 0)
                        for (null == this._pathDic && (this._pathDic = {}), h = 0,
                ...
                value: function _createGraphics() {
                    ...
                    if (r && r.length > 0)
                        for (this._drawOrderIndex = 0, i = r[this._drawOrderIndex]; a >= i.time && (this._drawOrder = i.drawOrder,
                    ...
                    if (this._isDestroyed) this.destroy();
                        ...
                        for (t = 0; t < r; t++) {
                            i = this._path + n[2 * t], s = n[2 * t + 1], a.getFloat32(), a.getFloat32(), a.getFloat32(),
                                a.getFloat32(), a.getFloat32(), a.getFloat32(), a.getFloat32(), a.getFloat32(), -1 == this._loadList.indexOf(i) && this._loadList.push(i);
                        }
                        ...
                        for ((wt = new w()).name = Vt[Yt++], Lt = o.getUint8(), a = 0; a < Lt; a++) {
                            for ((kt = new P()).name = Vt[Yt++], bt = this.boneSlotDic[kt.name], Ut = o.getUint8(),
                                ...
                                if (Pt = new k(), this.skinSlotDisplayDataArr.push(Pt), Pt.name = Vt[Yt++], Pt.attachmentName = Vt[Yt++],
                                    ...
                                    Pt.height = o.getFloat32(), Pt.type = o.getUint8(), Pt.verLen = o.getUint16(), (X = o.getUint16()) > 0)
                                    for (Pt.bones = [],
                                        s = 0; s < X; s++) {
                                        var Xt = o.getUint16();
                                        Pt.bones.push(Xt);
