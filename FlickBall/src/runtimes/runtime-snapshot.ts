...
export function heapsnapshot(module: any, callback: (snapshot: ArrayBuffer) => void) {
    module.onglobals = (...globals: any[]) => {
        ...
        // zeroing useless memory
        mem.fill(0, module._gamepix_buffers_start(), module._gamepix_buffers_end());
...
export function heaprestore(module: any, buffer: ArrayBuffer): Timestamp {
