...
(() => {
	var e = {
			732: (e, t, r) => {
				...
				function logError(e, t, r) {
					...
					r.message && (s.message = r.message), r.prefix && (s.message = "".concat(r.prefix, " ").concat(s.message)), n.Z[window.YaGames ? "postToParent" : "post"]({
						data: {
							error: s,
			...
			2861: (e, t, r) => {
				...
				r(4916), r(5306);
				const c = "object" == typeof window && !1;
				const u = new class Messaging {
						constructor() {
						...
						_addEventListener() {
							window.addEventListener("message", (e => {
								...
								if ("YandexGamesSDK" === r) {
									if (c && window !== window.parent && e.source === window.parent && e.origin === window.location.origin) return this.post(e.data), void("messaging" === n && "confirm" === t ? this.receivedMessages.push(o) : o && u.postToParent({
										type: "messaging",
										action: "confirm",
										uuid: o
									}));
									0, this._handleEvent(e)
								}
							}))
						}
						_handleEvent(e) {
						...
						postToParent(e) {
							...
							return t ? (!c || "messaging" === e.type && "confirm" === e.action || (e.uuid = Math.random().toString(36).substring(2, 15), setTimeout((() => {
			...
			6085: (e, t, r) => {
				...
				const logError = function(e, t) {
					...
					s = s || (null == t ? void 0 : t.message) || String(e), c = c || (null === (n = null === (r = window.Ya) || void 0 === r ? void 0 : r.Rum) || void 0 === n ? void 0 : n.ERROR_LEVEL.ERROR) || "error", t = t || e;
			...
			260: (e, t, r) => {
				...
				if ((!x || !E || E === A) && (E = w.prototype, x))
					for (n in C) i[n] && h(i[n].prototype, E);
				if (x && f(b) !== E && h(b, E), a && !c(E, P))
					for (n in T = !0, d(E, P, {
							get: function() {
				...
				if (a) {
					if (!c((function() {
						...
						for (var D, M = (x = function ArrayBuffer(e) {
							...
							}).prototype = O.prototype, U = _(O), j = 0; U.length > j;)(D = U[j++]) in x || i(x, D, O[D]);
						M.constructor = x
					}
					g && h(C) !== k && g(C, k);
					var N = new T(new x(2)),
			...
			654: (e, t, r) => {
				...
				e.exports = function(e, t, r, l, f, b, w) {
					...
					if (k && (E = a(k.call(new e)), h !== Object.prototype && E.next && (p || a(E) === h || (i ? i(E, h) : "function" != typeof E[_] && c(E, _, returnThis)), s(E, P, !0, !0), p && (d[P] = returnThis))), f == m && T && T.name !== m && (O = !0, C = function values() {
							return T.call(this)
						}), p && !w || x[_] === C || c(x, _, C), d[t] = C, f)
						if (A = {
			...
			9843: (e, t, r) => {
				...
				a ? (j || (O.f = W, P.f = V, addGetter(B, "buffer"), addGetter(B, "byteOffset"), addGetter(B, "byteLength"), addGetter(B, "length")), n({
					target: "Object",
					stat: !0,
					forced: !j
				}, {
					...
					j ? i && (_ = t((function(e, t, r, n) {
						return u(e, _, s), T(m(t) ? isArrayBuffer(t) ? void 0 !== n ? new g(t, h(r, a), n) : void 0 !== r ? new g(t, h(r, a)) : new g(t) : Y(t) ? fromList(_, t) : E.call(_, t) : new g(f(t)), e, _)
						...
						var o, i, c, l = 0,
							p = 0;
						if (m(t)) {
							if (!isArrayBuffer(t)) return Y(t) ? fromList(_, t) : E.call(_, t);
							o = t, p = h(r, a);
							var g = t.byteLength;
							if (void 0 === n) {
								if (g % a) throw D(q);
					...
					})), b && b(_, G), v = _.prototype = y(B)), v.constructor !== _ && p(v, "constructor", _), N && p(v, N, s), P[s] = _, n({
						global: !0,
						forced: _ != g,
						sham: !j
			...
			8674: (e, t, r) => {
				...
				var n, o, a, i, s = r(2109),
					...
					onUnhandled = function(e) {
						A.call(u, (function() {
							...
							if (isUnhandled(e) && (t = T((function() {
									L ? Y.emit("unhandledRejection", n, r) : dispatchEvent(z, r, n)
					...
					onHandleUnhandled = function(e) {
						A.call(u, (function() {
							var t = e.facade;
							L ? Y.emit("rejectionHandled", t) : dispatchEvent("rejectionhandled", t, e.value)
						}))
					},
					bind = function(e, t, r) {
						return function(n) {
				...
				$ && (G = function Promise(e) {
					...
					then: function then(e, t) {
						var r = N(this),
							n = q(E(this, G));
						return n.ok = "function" != typeof e || e, n.fail = "function" == typeof t && t, n.domain = L ? Y.domain : void 0, r.parent = !0, r.reactions.push(n), 0 != r.state && notify(r, !1), n.promise
					},
					catch: function(e) {
				...
				n("replace", 2, (function(e, t, r, n) {
					...
					return [function replace(r, n) {
						...
						for (var A, S = "", P = 0, O = 0; O < w.length; O++) {
							E = w[O];
							for (var x = String(E[0]), T = p(d(i(E.index), v.length), 0), C = [], k = 1; k < E.length; k++) C.push(void 0 === (A = E[k]) ? A : String(A));
							var I = E.groups;
							if (m) {
								var L = [x].concat(C, T, v);
								void 0 !== I && L.push(I);
								var R = String(n.apply(void 0, L))
							} else R = u(x, v, T, C, I, n);
							T >= P && (S += v.slice(P, T) + R, P = T + x.length)
						}
						return S + v.slice(P)
					}]
				}))
									...
									if (!I.test(i)) {
										if (i == n || "/" == i || "?" == i || "#" == i || "\\" == i && isSpecial(e) || r) {
											if ("" != h) {
												var w = parseInt(h, 10);
												if (w > 65535) return T;
												e.port = isSpecial(e) && w === q[e.scheme] ? null : w, h = ""
											}
											if (r) return;
											l = ce;
											continue
					...
					if (S) n(e, r, S);
						...
						if (O) {
							var x = u(A),
								T = !x && p(A),
								C = !x && !T && g(A);
							P = A, x || T || C ? u(E) ? P = E : l(E) ? P = i(E) : T ? (O = !1, P = o(A, !0)) : C ? (O = !1, P = a(A, !0)) : P = [] : h(A) || c(A) ? (P = E, c(E) ? P = v(E) : f(E) && !d(E) || (P = s(A))) : O = !1
						}
						O && (w.set(A, P), y(P, A, m, b, w), w.delete(A)), n(e, r, P)
					}
				}
			},
			5976: (e, t, r) => {
	...
	(() => {
		...
		const _ = (0, o.Z)(window.location),
			...
			b = ("passport".concat("", ".yandex.").concat(m), "https://avatars.mds.yandex.net");
		...
		function disableContentAds() {
			S || (S = !0, function _disableContentAds() {
				E("_disableContentAds"),
					...
					function replaceAdvManager() {
						...
						Object.defineProperty(window, "Ya", {
							...
							AdvManager: n
						}, window.Ya.Context.AdvManager = n, E("disable Ya.Context.AdvManager.render")
					}()
			}())
		}
		...
		class AdvManager {
			constructor(r) {
				var n;
				this.options = r, this.adOpened = !1, this.callbacks = [], this.lastShowTime = 0, this.startTime = Date.now(), this.adv = this.options.adv || {}, (null === (n = window.YandexGamesSDKEnvironment) || void 0 === n ? void 0 : n.isWorldWide) && this.setDisabledState(!0), Object.defineProperty(this, "callbacks", {
					enumerable: !1
					...
					switch (t.data.action) {
						...
						case "adv-callback-close":
							this.adOpened = !1, this.lastShowTime = Date.now(), this._hideAdv(t.data.data.wasShown);
							break;
						...
						case "set-disabled-state":
							P('On "set-disabled-state" event', t.data, t.data.data.value), this.setDisabledState(t.data.data.value)
					}
			...
			setDisabledState(e) {
				P("setDisabledState", e), e ? disableContentAds() : function enableContentAds() {
					S && (S = !1)
				}()
			}
			openAdLock(t) {
				...
				if (this.adOpened) {
					...
					return (0, e.fF)(o), null === (r = t.onError) || void 0 === r || r.call(t, o), null === (n = t.onClose) || void 0 === n || n.call(t), !1
				}
			...
			showFullscreenAdv({
				...
				if (this.openAdLock(r)) return this._addCallbacks(r, ["onClose", "onOpen", "onError", "onOffline"]), t.Z.postToParent({
					type: "adv-manager",
			...
			showRewardedVideo({
				...
				if (this.openAdLock(r)) return this._addCallbacks(r, ["onOpen", "onRewarded", "onClose", "onError"]), t.Z.postToParent({
					type: "adv-manager",
		...
		const x = new class AuthManagerPrivate {
			...
			switchAuthState(e) {
				this.hasAuthValue !== e && (O("switch auth state to ".concat(e)), this.hasAuthValue = e)
			}
			getAuthState() {
				t.Z.postToParent({
					type: "auth",
		...
		var C = __webpack_require__(7114);
		const k = __webpack_require__(4089).default;
		__webpack_require__(4603), __webpack_require__(5827);
		const I = ["az", "by", "co.il", "com", "com.am", "com.ge", "com.tr", "ee", "fr", "kg", "kz", "lt", "lv", "md", "ru", "tj", "tm", "ua", "uz"],
			L = {
				az: ["az"],
				by: ["be", "ru"],
				"co.il": ["he"],
		...
		Object.keys(L).reduce(((e, t) => (e[t] = L[t][0], e)), {});
		var R, D;
		! function(e) {
		...
		generateServiceUrls(B.YANDEX, I).concat(generateServiceUrls(B.PLAYHOP, ["com"])).concat(["https://zenadservices.net"]);
		var Y;
		! function(e) {
		...
		const K = I.map((e => e.replace(".", "\\."))).join("|");
		new RegExp("^https://(www\\.)?".concat(B.YANDEX, "\\.(").concat(K, ")$")), new RegExp("^https://([^.]+\\.)*".concat(B.YANDEX, "\\.(").concat(K, ")\\/")), new RegExp("^https?://(?:.*?\\.)*".concat(B.YANDEX, "\\.(").concat(K, ")").concat(H.YANDEX, "/manifest/play/\\d+/?")), M.L, M.RECOMMENDED_NEW, M.ADAPTIVE_RECOMMENDED_NEW, M.PREMIUM_BIG, M.TV;
		var q;
		! function(e) {
		...
		const W = "0/0-0",
			V = {
				small: q.ISLANDS_RETINA_SMALL,
				medium: q.ISLANDS_RETINA_MEDIUM,
				large: q.ISLANDS_200
			},
			Z = {
				small: q.ISLANDS_200,
				medium: q.ISLANDS_200,
				large: q.BIG
			},
			z = "".concat(y, "/player"),
			$ = "".concat(b, "/get-yapic/");
		...
		class Leaderboards {
			...
			transformLeaderboardEntry(e) {
				const {
					...
					scopePermissions: o,
					uniqueID: a
				} = e.player, i = "".concat(z, "/avatar/").concat(t);
				return Object.assign(Object.assign({}, e), {
					player: {
						getAvatarSrc: (e = "medium") => (V[e] || (e = "medium"), "".concat(i, "/").concat(V[e])),
						getAvatarSrcSet: (e = "medium") => (V[e] || (e = "medium"), "".concat(i, "/").concat(V[e], " 1x, ").concat(i, "/").concat(Z[e], " 2x")),
						lang: r,
						publicName: n,
						scopePermissions: o,
						uniqueID: a
			...
			setLeaderboardScore(e, t, r) {
				...
				return this.lastTimeLeaderboardWasSend && !this.canSetLeaderboardScoreByTime() ? Promise.reject("The request to setLeaderboardScore can be sent no more than once per second") : (r && (n.extraData = r), this.lastTimeLeaderboardWasSend = Date.now(), Q("/score", n))
			}
		...
		var ee, te = __webpack_require__(1420);
		__webpack_require__(1817), __webpack_require__(7673);
		! function(e) {
			e.YANDEX_NAME = "yandexName", e.SERVICE_NAME = "serviceName", e.APPLICATIONS_CATEGORY_SERVICE_NAME = "applicationsCategoryServiceName"
		}(ee || (ee = {}));
		ee.YANDEX_NAME, ee.SERVICE_NAME, ee.APPLICATIONS_CATEGORY_SERVICE_NAME;
		const re = ["ru", "uk", "be", "kk", "uz"],
			isCubrLanguage = e => !e || re.includes(e);
		var ne, oe, ae, ie, se;
		! function(e) {
		...
		const he = "//yastatic.net/s3/games-static/static-data/images/payments/sdk";
		let sendOnceCurrencyCodeStat = function() {
			sendOnceCurrencyCodeStat = () => {}, k.params({
				borrowParams: {
					payments: {
						appId: (0, w.rh)(),
		...
		class Product {
			...
			getPriceCurrencyImage(e = fe.SMALL) {
				if (e === fe.SVG) return "".concat(he, "/currency-icon-m.svg");
				let t = "s";
				switch (e) {
					case fe.MEDIUM:
					case fe.SMALL:
				...
				return "".concat(he, "/currency-icon-").concat(t).concat(r ? "@2x" : "", ".png")
			}
			toJSON() {
				return {
					id: this.id,
		...
		const ge = class NativeShim {
			...
			_e = ge.Symbol("PurchaseData");
		class Purchase {
			constructor(e) {
				"purchaseTime" in e || (e.purchaseTime = 0), this[_e] = e
			}
			get productID() {
				return this[_e].productID
			}
			get purchaseTime() {
				return this[_e].purchaseTime
			}
			get purchaseToken() {
				return this[_e].purchaseToken
			}
			get developerPayload() {
				return this[_e].developerPayload
			}
			toJSON() {
				return {
			...
			getCatalog() {
				return new Promise(((e, r) => {
					t.Z.postToParent({
						...
						ve("get-catalog result", t), e(t.products.map((e => new Product(e))))
					})).catch((e => {
						r(e)
					}))
				}))
			...
			consumePurchase(e) {
				return new Promise(((r, n) => {
					t.Z.postToParent({
						...
						if (console.info("consumePurchase data"), console.info(e), !e || !e.token) throw new te.Z({
		...
		const me = function getPayments(e = {}) {
		...
		class LastSendGuard {
			...
			validate(e) {
				...
				return function byteLength(e) {
					...
					error: new Error("The data is too large (bigger then ".concat(be, " bytes).")),
					reject: !0
				} : this._dataHash === t ? {
		...
		const we = ge.Symbol("PlayerData"),
			Ee = ge.Symbol("PlayerConfig");
		...
		class Player extends class PlayerBase {
			...
			getID() {
				return (0, e.Ts)(new Error("Player.getID() is deprecated. Please, use Player.getUniqueID().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player.html#sdk-player__profile-data")), k.sendOnceDeprecatedUsage("Player.getID"), this._personalInfo.id
			}
			getUniqueID() {
			...
			constructor(e, t) {
				super(e), this[we] = void 0, this[Ee] = t, Se && Se.isSamePlayer(this.getUniqueID()) || (Se = new LastSendGuard(this.getUniqueID()))
			}
			getIDsPerGame() {
				return this._fetchData("-ids-per-game")
			}
			getData(e) {
				return void 0 === this[we] ? this._fetchData("/data").then((t => (this[we] = t, filterDataByKeys(t, e)))) : Promise.resolve(filterDataByKeys(this[we], e))
			}
			setData(t, r = !1) {
				...
				const n = function sendData(t, r = !1) {
					const n = Se.validate(t);
					return n.error ? n.reject ? Promise.reject(n.error) : ((0, e.Ts)(n.error), Promise.resolve(!0)) : new Promise(((e, n) => {
						Ae && window.clearTimeout(Ae);
						let o = r ? 0 : Se.getWaitTime();
						Se.timestamp = Date.now(), Ae = window.setTimeout((() => {
			...
			_fetchData(e) {
				return player_fetch_fetchData("".concat(e).concat(this[Ee].signed ? "-signed" : "")).then(convertResponseData)
			}
			_postData(e, t) {
				return fetch_postData("".concat(e).concat(this[Ee].signed ? "-signed" : ""), t).then(convertResponseData)
			}
		}
		try {
			Pe = window.localStorage
		} catch (st) {}
		const Oe = Pe || function getInMemoryLocalStorage() {
				let e = {};
				return {
					clear() {
						e = {}
			...
			xe = /iPad|iPhone|iPod/.test(navigator.platform),
			Te = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
			Ce = xe || Te,
			ke = /app-[^.]+\.games\.s3\.yandex\.net$/.test(window.location.hostname),
			Ie = !ke && Ce;
		class LocalStorageWrapper {
			static setup() {
				Ie && Object.defineProperty(window, "localStorage", {
					get: function() {
						return (0, e.fF)(new Error("localStorage is broken on iOS/MacOS - https://developer.apple.com/forums/thread/109909\nPlease use YaGames.init().then(ysdk => ysdk.getStorage()).then(storage => storage.setItem('key', 'value'))")), Oe
					}
				}), Ce && ke && LocalStorageWrapper.setProxy() && LocalStorageWrapper.backup()
			}
			static load() {
				...
				})), LocalStorageWrapper.onloadPromise_) : Promise.resolve(Oe)
			}
			static getCustomLocalStorage() {
				if ("function" != typeof Proxy) return null;
				return new Proxy({
					clear() {
						Oe.clear.call(Oe), t.Z.postToParent({
							type: "local-storage",
							action: "clear"
						})
					},
					getItem: e => Oe.getItem.call(Oe, e),
					key: e => Oe.key.call(Oe, e),
					get length() {
						return Oe.length
					},
					removeItem(e) {
						Oe.removeItem.call(Oe, e), t.Z.postToParent({
							type: "local-storage",
							action: "del",
							data: {
								key: e
					...
					setItem(e, r) {
						Oe.setItem.call(Oe, e, String(r)), t.Z.postToParent({
							type: "local-storage",
							action: "set",
							data: {
								key: e,
		...
		function getStorage() {
			return !Ce && Pe ? Promise.resolve(Pe) : LocalStorageWrapper.load()
		}
		...
		const Le = new class ClipboardPublic {
				writeText(e) {
					try {
						e = String(e)
					} catch (r) {
			...
			Re = {
				android: () => !Re.windows() && find("android"),
				androidPhone: () => Re.android() && find("mobile"),
				androidTablet: () => Re.android() && !find("mobile"),
				blackberry: () => find("blackberry") || find("bb10") || find("rim"),
				blackberryPhone: () => Re.blackberry() && !find("tablet"),
				blackberryTablet: () => Re.blackberry() && find("tablet"),
				cordova: () => Boolean(window.cordova && "file:" === window.location.protocol),
				desktop: () => !Re.tablet() && !Re.mobile(),
				fxos: () => (find("(mobile") || find("(tablet")) && find(" rv:"),
				fxosPhone: () => Re.fxos() && find("mobile"),
				fxosTablet: () => Re.fxos() && find("tablet"),
				ios: () => Re.iphone() || Re.ipod() || Re.ipad(),
				ipad: () => find("ipad"),
				iphone: () => !Re.windows() && find("iphone"),
				ipod: () => find("ipod"),
				landscape: function() {
				...
				meego: () => find("meego"),
				mobile: function() {
					return Re.androidPhone() || Re.iphone() || Re.ipod() || Re.windowsPhone() || Re.blackberryPhone() || Re.fxosPhone() || Re.meego()
				},
				...
				tablet: function() {
					return Re.ipad() || Re.androidTablet() || Re.blackberryTablet() || Re.windowsTablet() || Re.fxosTablet()
				},
				tv: () => Me.some((e => find(e))),
				get type() {
				...
				windowsPhone: () => Re.windows() && find("phone"),
				windowsTablet: () => Re.windows() && find("touch") && !Re.windowsPhone()
			},
			De = "undefined" == typeof window ? "" : window.navigator.userAgent.toLowerCase(),
			Me = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo", "roku", "dlnadoc", "pov_tv", "hbbtv", "ce-html", "yandexmodule", "androidtv"];
		...
		function find(e) {
			return includes(De, e)
		}

		function findMatch(e) {
			for (let t = 0; t < e.length; t += 1)
				if (Re[e[t]]()) return e[t];
			return "unknown"
		}
		const Ue = Re,
			je = {
		...
		let getEnv = () => (window.YandexGamesSDKEnvironment || (0, e.fF)(new Error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined")), getEnv = () => window.YandexGamesSDKEnvironment || Ne, getEnv());
		const Fe = {
			get app() {
				return getEnv().app
			},
			...
			prepare_error_event = e => {
				const t = (e => e.map((e => {
						if ("object" == typeof e) try {
							...
							return "".concat(e, ": ").concat(st.message)
						}
						return String(e)
					})).join(" "))(e),
					r = (e => {
		...
		new class ErrorListener {
			...
			_unsafeHandleErrorEvent(e, t) {
				...
				(Ge || (null == s ? void 0 : s.additional)) && (c.additional = Object.assign(Object.assign({}, null == s ? void 0 : s.additional), Ge)), this._postError(c, t)
			}
			_postError(t, r) {
				var n;
		...
		var qe = __webpack_require__(2492),
					...
					return function ensurePartner(e) {
						...
						function ensureScreen(e) {
							...
							return t = function ensureFullscreen(e) {
								...
								}(e.fullscreen) : e.fullscreen = !je.isDesktop();
								return e
		...
		class ScopesChecker {
			...
			isNeedToAskUser() {
				return [Ze.AVATAR, Ze.NAME].some((e => this._requestedScopes.includes(e) && this._scopePermissions[e] === Ve.NOT_SET))
			}
			_validateRequestedScopes(e) {
				let t = [];
				t = Array.isArray(e) ? Array.from(e) : void 0 === e || !0 === e ? [ze] : [];
				const r = t.indexOf(ze);
				return -1 !== r && t.splice(r, 1, Ze.AVATAR, Ze.NAME), t
			}
		}
		...
		const Xe = class ScreenManager {
				...
				_isFullscreenEnabled() {
					return Boolean(this._options.fullscreen && $e)
				}
			...
			Je = ge.Symbol("screenManagerInstance");
		class FullscreenManager {
			constructor(e) {
				...
				}, this[Je] = e, this._overrideBrowserFullscreenElement(), this._initMessaging()
			}
			get STATUS_ON() {
				return "on"
			}
			...
			get status() {
				return this[Je]._hasFullscreenElement() ? this.STATUS_ON : this.STATUS_OFF
			}
			request() {
				return this[Je]._requestFullscreen({
					force: !0
				})
			}
			exit() {
				return this[Je]._exitFullscreen({
					force: !0
				})
			}
			toggle() {
				return this[Je]._toggleFullscreen({
					force: !0
				})
			}
		...
		class ScreenManagerPublic {
			constructor(e) {
				this[Je] = new Xe(e), this.fullscreen = new FullscreenManager(this[Je])
			}
		}
		var Qe;
		! function(e) {
		...
		const tt = ["passport.yandex", "an.yandex.ru", "avatars.mds.yandex.net", "/api/"];
		...
		const ot = function setTmpPlayTimeTimers() {
		...
		function initDevFoolproof() {
			! function sdkIsCorreclyPlaced() {
				...
				null === (e = window.top) || void 0 === e || e.postMessage({
					...
					url: location.href,
					draftDetectedInIframe: (0, w.mv)()
				}, "*")
			}()
		}();
		let at;
		getDebugLog("sdkv2")("APP_VERSION", "1656398125");
		class YaGamesCreater {
			constructor(e) {
				var r;
				e = ensureOptions(e), this.EVENTS = {
					EXIT: Qe.EXIT,
					HISTORY_BACK: Qe.HISTORY_BACK
				...
				}(), this.onEvent = getSdkEventsHandler(), this.adv = new AdvManager(e), this.auth = T, this.clipboard = Le, this.deviceInfo = je, this.environment = Fe, this.feedback = Ye, this.isAvailableMethod = (r = this, e => t.Z.postToParent({
					type: "auth",
					action: "has-auth"
				}).then((({
					data: t
					...
					return !1
				}))), this.shortcut = nt, this.getLeaderboards = leaderboards, this.getPayments = v2_payments, this.getPlayer = get_player_getPlayer, this.getStorage = getStorage, this.notifications = Ke, this.screen = new ScreenManagerPublic(e.screen), this.yandexApp = {
					enabled: v
				}
			}
		}
		...
		class YaGames {
			...
			static init(t) {
				return at ? (console.warn("YaGames was initialized"), at) : (at = new Promise(((r, n) => {
		...
		if (YaGames.deviceInfo = je, window.YaGames) {
			...
			window.top !== window && waitDocumentReady().then(back_button_logic),
				...
				}(document.querySelector("iframe")), rt.overrideCacheSearch(), ot()
		}
		window.YaGames = YaGames;
		const it = YaGames
	})(), YaGames = r.default
})();
//# sourceMappingURL=https://s3.mdst.yandex.net/games/source-maps/v1656398125/sdk/v2.js.map
