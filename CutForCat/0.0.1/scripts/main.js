    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (this._useWorker && (typeof OffscreenCanvas === "undefined" || !navigator["userActivation"] ||
                    !SupportsWorkerTypeModule())) this._useWorker = false;
            ...
            if ((this._exportType === "html5" || this._exportType === "playable-ad") &&
                this._isFileProtocol) alert("Exported games won't work until you upload them. (When running on the file: protocol, browsers block many features from working for security reasons.)");
        ...
        async _Init(opts) {
            ...
            if (opts.workerScripts) this._workerScriptURLs =
                opts.workerScripts;
        ...
        _GetCommonRuntimeOptions(opts) {
            return {
                ...
                "isDebug": self.location.search.indexOf("debug") >
                    -1,
                "ife": !!self.ife,
