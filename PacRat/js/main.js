...
function CMain(oData){
	...
	createjs.Ticker.addEventListener("tick", this._update);
        ...
        //ADD PRELOADER
if(seekAndDestroy()){_oPreloader = new CPreloader();}else{window.location.href = 'http://www.codethislab.com/contact-us.html' }
...
function CHero(iX,iY,iRow,iCol,oParentContainer){
    ...
    this._init = function(iX,iY,iRow,iCol){
        ...
        var oData = {   
                        ...
                        animations: {start:0,idle: [0, 23, "idle"], walk: [24, 39, "walk"], attack: [40, 55, "attack"], die: [56, 77, "stop_die"],stop_die:77}
                   };
...
function CEnemy(iIndex,iX,iY,iRow,iCol,oParentContainer){
    ...
    this._init = function(iIndex,iX,iY,iRow,iCol){
        ...
        var oData = {   
                        ...
                        animations: {start:0,walk: [0, 15, "walk"], escape: [16, 31, "escape"], die: [32, 53, "stop_die"],stop_die:53,ghost:20}
                   };
...
PLAYER_START[0] = {row:14,col:9};
PLAYER_START[1] = {row:15,col:9};
PLAYER_START[2] = {row:15,col:9};
PLAYER_START[3] = {row:14,col:9};
PLAYER_START[4] = {row:16,col:9};
PLAYER_START[5] = {row:16,col:9};


var ENEMY_START = new Array();
ENEMY_START[0] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
ENEMY_START[1] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
ENEMY_START[2] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
ENEMY_START[3] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
ENEMY_START[4] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
ENEMY_START[5] = [{row:10,col:8},{row:10,col:9},{row:10,col:10}];
