...
function sizeHandler() {
    ...
    $("#gameCanvas").css("width", destW + "px");
    $("#gameCanvas").css("height", destH + "px");

    if (fOffsetY < 0) {
        $("#gameCanvas").css("top", fOffsetY + "px");
    ...
    $("#gameCanvas").css("left", fOffsetX + "px");
    ...
    $(window).trigger("gameResize", [s_iOffsetX, s_iOffsetY]);
};
...
function resizeCanvas3D() {
    $("canvas").each(function () {
        if ($(this).attr("id") == "#gameCanvas") {
            return;
        }
        $(this).css("width", $("#gameCanvas").css("width"));
        $(this).css("height", $("#gameCanvas").css("height"));
        $(this).css("position", $("#gameCanvas").css("position"));
        $(this).css("left", $("#gameCanvas").css("left"));
        $(this).css("top", $("#gameCanvas").css("top"));
    });
}
